...
Route::prefix('v1')->middleware(['auth:sanctum', 'throttle:120,1'])->group(function () {
    ...
    // Rack Ratings
    Route::post('/racks/{rack}/rate', [RackRatingController::class, 'store']);
    Route::put('/racks/{rack}/rate', [RackRatingController::class, 'update']);
    Route::delete('/racks/{rack}/rate', [RackRatingController::class, 'destroy']);
    
    // Comments
    Route::get('/racks/{rack}/comments', [CommentController::class, 'index']);
    Route::post('/racks/{rack}/comments', [CommentController::class, 'store']);
    ...
    Route::post('/collections/{collection}/racks/{rack}', [CollectionController::class, 'addRack']);
    Route::delete('/collections/{collection}/racks/{rack}', [CollectionController::class, 'removeRack']);
});
